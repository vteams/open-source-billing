    ...
    resource :payments do
     ...
     before {current_user}
      ...
      get do
        ...
        @payments = @payments.joins('LEFT JOIN clients as payments_clients ON  payments_clients.id = payments.client_id').joins('LEFT JOIN invoices ON invoices.id = payments.invoice_id LEFT JOIN clients ON clients.id = invoices.client_id ').select('payments.*, clients.organization_name')
      end
