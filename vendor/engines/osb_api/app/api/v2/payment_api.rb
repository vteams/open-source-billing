    ...
    resource :payments do
      ...
      get do
        ...
        @payments = {total_invoices: Invoice.all.unscoped.count, total_records: @payments.total_count,
                     ...
                     per_page: @payments.limit_value, min_invoice_number: Invoice.count > 0 ? Company.find(@current_user.current_company).invoices.with_deleted.minimum('id') : 0,
                     max_invoice_number: Invoice.count > 0 ? Company.find(@current_user.current_company).invoices.with_deleted.maximum('id') : 0, payments: @payments}
      end
