module OSB
  module CONFIG
    ...
    PAYPAL_LOGIN ||= APP_CONFIG[:PAYPAL][:PAYPAL_LOGIN]
    PAYPAL_PASSWORD ||= APP_CONFIG[:PAYPAL][:PAYPAL_PASSWORD]
    PAYPAL_SIGNATURE ||= APP_CONFIG[:PAYPAL][:PAYPAL_SIGNATURE]
    PAYPAL_BUSINESS ||= APP_CONFIG[:PAYPAL][:PAYPAL_BUSINESS]
