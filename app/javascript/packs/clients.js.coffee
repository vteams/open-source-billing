...
class window.Client
  ...
  @ClientCountryState = ->
    if $('#client_country').children('option:selected').val() == 'United States'
      $('.country_state_text_field').hide()
      $('.canada_state_dropdown').hide()
      $('.us_state_dropdown').show()
    else if $('#client_country').children('option:selected').val() == 'Canada'
      $('.country_state_text_field').hide()
    ...
    $('#newClient').submit ->
      if $('#client_country').children('option:selected').val() == 'United States'
        $('.country_state_text_field > input').val($('.us_state_dropdown > #client_province_state').children('option:selected').val());
      else if $('#client_country').children('option:selected').val() == 'Canada'
        $('.country_state_text_field > input').val($('.canada_state_dropdown > #client_province_state').children('option:selected').val());
