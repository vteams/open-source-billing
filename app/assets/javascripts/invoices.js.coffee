...
window.applyChosen = (single_row) =>
  ...
  jQuery(".chzn-select:not('.invoice_company, .company_filter, .frequency_select, .per_page, .discount_select, .invoice_currency, .recurring_profile_currency, .report_manager, .report_billing_method')",'.estimates-main, .projects-main, .invoices-main,.recurring_profiles-main').on "liszt:ready", ->
