...
#    sortList: sort_list
  ...
  jQuery('#select_all').on "click",null, ->
  ...
  jQuery('#main-invoice-checkbox').on "click",null, ->
  ...
  jQuery('table.table_listing tbody :checkbox').on "click",null, ->
  ...
  jQuery(".top_links").on "click",null, ->
  ...
  #
  jQuery('.options_content :checkbox').on "click",null, ->
