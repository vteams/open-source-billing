module CompaniesHelper
  ...
  def companies_archived(ids)
    notice = <<-HTML
     ...
     <a href="companies/filter_companies?status=archived#{query_string(params.merge(per: session["#{controller_name}-per_page"]))}" data-remote="true">Archived</a> section on this page.</p>
  ...
  def companies_deleted(ids)
    notice = <<-HTML
     ...
     <a href="companies/filter_companies?status=deleted" data-remote="true">Deleted</a> section on this page.</p>
